          ...
          <div class="inline">
            ...
            <ul>
              <li v-for="(e, i) in inlineDrones" :key="e.id">
                ...
                <span>{{e.flyer_id | flyerId(flyers)}}</span>
                <!-- <span>{{e.drone_id | droneModel(drones)}}</span> -->
                <span>{{e.flyer_id | teamId(teams)}}</span>
...
export default {
  ...
  data () {
    return {
      ...
      inlineDrone: [
        {img: '../../../static/img/u17.jpg', name: '飞手1', type: '机型1', unit: '思明公安无人机1队',latitude: '112.12345131654445', longtitude: '23.12312222222244'},
        {img: '../../../static/img/u17.jpg', name: '飞手2', type: '机型2', unit: '思明公安无人机1队',latitude: '118.116646', longtitude: '24.471346'},
        {img: '../../../static/img/u17.jpg', name: '飞手3', type: '机型3', unit: '思明公安无人机1队',latitude: '118.118646', longtitude: '24.441346'},
        {img: '../../../static/img/u17.jpg', name: '飞手4', type: '机型4', unit: '思明公安无人机1队',latitude: '118.125646', longtitude: '24.481346'},
        {img: '../../../static/img/u17.jpg', name: '飞手5', type: '机型5', unit: '思明公安无人机1队',latitude: '118.116646', longtitude: '24.461346'},
      ],
      inlineDrones: [],
      inlineLists: [],
  ...
  methods: {
    ...
    mapInit () {
      ...
      this.map.setCenter([center.longtitude, center.latitude])
      // this.map.setFitView()
    },
    markerInit () {
      ...
      this.inlineDrones.forEach((item, i) => {
        ...
        marker = new AMap.Marker({
          position: new AMap.LngLat(item.latitude, item.longtitude),
          map: this.map,
          clickable: true,
    ...
    activePosition (e, i) { // 定位某个无人机
      ...
      let marker = ''
      marker = new AMap.Marker({
        position: new AMap.LngLat(e.latitude, e.longtitude),
        map: this.map,
        // icon: '//a.amap.com/jsapi_demos/static/demo-center/icons/poi-marker-default.png',
  ...
  filters: {
    ...
    teamId (fid, teams) { // 根据id显示团队名称
      let val = ''
      teams.forEach(e => {
        // e.flyers.split('').join('').forEach(item => {
        //   console.log(item)
        // })
        console.log(e.flyers.split('').join(''))
        // if (e.flyers === fid) {
        //   val = e.nickname
        // }
      })
